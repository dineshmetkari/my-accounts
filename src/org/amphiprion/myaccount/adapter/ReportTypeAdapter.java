 ...
 * 
 */
public class ReportTypeAdapter extends ArrayAdapter<Type> {

	/**
	 * Default constructor.
	 */
	public ReportTypeAdapter(Context context) {
		super(context, android.R.layout.simple_spinner_item, Type.values());
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		((TextView) view).setText(res.getString(res.getIdentifier(
				"report_type_" + Type.values()[position].getDbValue(), "string", ApplicationConstants.PACKAGE)));
